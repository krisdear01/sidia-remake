      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 rounded-2xl bg-white p-6 shadow-sm border border-slate-100 relative overflow-hidden">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select className="block w-full appearance-none rounded-lg border border-slate-300 bg-slate-50 p-3 text-slate-900 focus:border-blue-500 focus:bg-white focus:ring-blue-500 sm:text-sm transition-all">
                <option>-- Select all --</option>
                <option>Kampus Jimbaran</option>
                <option>Kampus Sudirman</option>
                <option>Kampus Nias</option>
              </select>
